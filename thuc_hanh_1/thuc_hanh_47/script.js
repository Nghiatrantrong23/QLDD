...
const buttonTemplate =
  '<svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32"><path d="M24 22h-3.1721-5-5-5h3.172v17-7-7v5h-4c-0.53 0-1.039 0.211-1.414 0.586l-5.586 5.586c-0.375 0.375-0.884 0.586-1.414 0.586h-6v4h5.17215 5-5h-5.172v4h6c0.53 0 1.039-0.211 1.414-0.586l5.586-5.586 5.586 5.586c0.375 0.375 0.884 0.586 1.414 0.586h4v5l7-7-7-7v5z" /></svg>';
  ...
  for (let i = 0; i < allPoints.length; i++) {
    L.marker(allPoints[i], {
      icon: L.divIcon({
        ...
        html: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" class="marker"><path fill-opacity="0.25" d="M16 3251.427-9.585 3.761-12.025C4.595-4.805 8.685-9.685-9.994 4.004 3.964-.526 8.743C25.514 30.245 16 32 16 32Z"></path><path stroke="#fff" fill="#${randomColor()}" d="M15.938 3256 17.938 6 11.938C6 .125 15.938 0 15.938 0C16 .125 26 11.875C26 18.062 15.938 32 15.938 32Z"></path></svg>`,
        iconAnchor: [12, 24],
        popupAnchor: [9, -26],
      }),
    })
