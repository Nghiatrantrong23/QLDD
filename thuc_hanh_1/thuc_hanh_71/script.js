...
const points = [
  [52.230828586193795, 21.01083755943164, "point 1 first example"],
  [52.22924516170657, 21.011320352554325, "point 2 second example"],
  [52.229511304688444, 21.01207973682404, "point 3 third example"],
];
...
function createLabel(layer, text) {
  ...
  const marker = L.marker(layer.getLatLng(), { icon }).addTo(map);
