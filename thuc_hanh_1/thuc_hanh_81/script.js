        ...
        const DirectionIndicator = L.Control.extend({
            onAdd: (map) => {
                ...
                pin.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="white">
                    <path d="M12 2c1.1 0 2 .9 2 2 0 1.1-.9 2-2 2s-2-.9-2-2 .9-2 2-2zm0 10c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/>
                </svg>`;
                pin.style.cssText = `
                    transform: rotate(${-screenAngle}deg);
                    display: flex;
...
// Initialize MarkerTracker with custom padding
